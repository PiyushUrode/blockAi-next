    ...
    <section className="bg-black text-white py-5 md:py-10 px-2 md:px-5 relative" id="mission">
      ...
      {selectedMission && (
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50 backdrop-blur-sm">
          <div className="bg-[#111] border shadow-[#fff] p-8 rounded-3xl w-[90%] sm:w-[600px] shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            <div className="text-gray-300 text-sm mb-4">
              <h3 className="text-lg text-pink-400 font-semibold mb-1">Overview</h3>
              <p>{selectedMission.details.overview}</p>
            </div>

            {/* Key Features */}
            <div className="text-gray-300 text-sm mb-4">
              <h3 className="text-lg text-pink-400 font-semibold mb-1">Key Features</h3>
            ...
            <div className="text-gray-300 text-sm mb-6">
              <h3 className="text-lg text-pink-400 font-semibold mb-1">Benefits</h3>
              <ul className="list-disc list-inside space-y-1">
